...
if xampp has error for run app, use wamp and move folder to "www" folder on wamp 
import mvc.sql to phpMyAdmin (username=Nahdiyar, password=Ijnhr1384 or username=root, empty password)
for connect to database change database config from config.php in "app/config"
